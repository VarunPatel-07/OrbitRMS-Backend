...
class EnvConfig:
    ...
    SENTRY_MONITORING_KEY = os.getenv("SENTRY_MONITORING_KEY")

    ORBITRMS_MEDIA_SERVICE_BASE_URL = os.getenv("ORBITRMS_MEDIA_SERVICE_BASE_URL")

    CLOUDFLARE_TURNSTILE_VERIFY_URL = os.getenv("CLOUDFLARE_TURNSTILE_VERIFY_URL")
