...
failureLogger = logging.getLogger("error")
failureLogger.setLevel(logging.ERROR)
failureLogger.addHandler(handler)
failureLogger.propagate = False


# Now This Are the Error File Like It Will Have The Log Only For The error
