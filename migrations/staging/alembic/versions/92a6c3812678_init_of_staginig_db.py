...
Revision ID: 92a6c3812678
Revises: 
Create Date: 2025-07-19 10:36:24.158723
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_organization_about_info_id'), 'organization_about_info', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_organization_address_id'), 'organization_address', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_organization_contact_info_id'), 'organization_contact_info', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_organization_general_info_id'), 'organization_general_info', ['id'], unique=False)
    ...
    op.create_table('client_form_schema',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_index(op.f('ix_client_inquires_data_id'), 'client_inquires_data', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_config_model_department_id'), 'config_model_department', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_config_model_designations_id'), 'config_model_designations', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_config_model_project_status_id'), 'config_model_project_status', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_organization_updates_id'), 'organization_updates', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_personal_contact_info_id'), 'personal_contact_info', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_config_role_associated_permissions_id'), 'config_role_associated_permissions', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_config_role_associated_permissions_id'), table_name='config_role_associated_permissions')
    ...
    op.drop_index(op.f('ix_config_model_project_status_id'), table_name='config_model_project_status')
