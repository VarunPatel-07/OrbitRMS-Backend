...
Revision ID: 7181e788da25
Revises: 
Create Date: 2025-12-14 11:43:15.546436
...
def upgrade() -> None:
    ...
    op.create_table('client_inquires',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    sa.Column('status', sa.Enum('scheduled', 'active', 'completed', 'cancelled', name='maintenance_status'), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['maintenance_mode_id'], ['maintenance_mode.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('orbit_admin_session',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('organization_about_info',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('organization_general_info',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    sa.Column('refill_from', sa.Enum('January', 'April', 'July', 'October', name='refill_quarter_start_enum'), nullable=True),
    ...
    op.create_index(op.f('ix_organization_leaves_settings_organization_id'), 'organization_leaves_settings', ['organization_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('queued', 'scheduled', 'posted', 'cancelled', name='post_status_enum'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['leave_type_id'], ['organization_leaves_settings.id'], ),
    sa.ForeignKeyConstraint(['notify_to_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_attendance_leave_module_leave_type_id'), 'attendance_leave_module', ['leave_type_id'], unique=False)
    op.create_table('client_inquires_data',
    ...
    op.create_table('config_model_department',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    sa.Column('department_name', sa.String(length=255), nullable=False),
    sa.Column('source_type', sa.Enum('default', 'user_created', name='source_type_enum'), nullable=False),
    ...
    op.create_table('config_model_designations',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('config_model_project_status',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('config_role_module',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('inquiry_form_schema',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    sa.Column('form_id', mysql.CHAR(length=36), nullable=False),
    sa.Column('form_name', sa.String(length=255), nullable=False),
    sa.Column('status', sa.Boolean(), nullable=False),
    ...
    op.create_table('organization_updates',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    sa.Column('images', sa.Text(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('isCommentDisabled', sa.Boolean(), nullable=True),
    ...
    op.create_table('personal_contact_info',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    op.create_table('attendance_leave_notify',
    sa.Column('leave_id', mysql.CHAR(length=36), nullable=False),
    sa.Column('user_id', mysql.CHAR(length=36), nullable=False),
    sa.ForeignKeyConstraint(['leave_id'], ['attendance_leave_module.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    ...
    sa.ForeignKeyConstraint(['family_info_id'], ['family_info.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('config_role_associated_permissions',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    sa.ForeignKeyConstraint(['parent_module_id'], ['config_role_associated_permissions.id'], onupdate='CASCADE', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['contact_id'], ['personal_contact_info.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['employee_role_id'], ['config_role_module.id'], ),
    ...
    op.create_index(op.f('ix_feed_comments_organization_update_id'), 'feed_comments', ['organization_update_id'], unique=False)
    ...
    op.create_index(op.f('ix_feed_likes_organization_update_id'), 'feed_likes', ['organization_update_id'], unique=False)
    op.create_index(op.f('ix_feed_likes_user_id'), 'feed_likes', ['user_id'], unique=False)
    op.create_table('inquiry_form_fields',
    sa.Column('id', mysql.CHAR(length=36), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['inquiry_form_schema_id'], ['inquiry_form_schema.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['associated_permissions_module_id'], ['config_role_associated_permissions.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
