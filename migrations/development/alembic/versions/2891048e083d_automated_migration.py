...
Revision ID: 2891048e083d
Revises:
Create Date: 2025-12-20 09:51:18.493373
...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "organization_general_info",
        ["indexed_email_domain"],
        unique=False,
    )
    op.create_index(
        op.f("ix_organization_general_info_primary_email"),
        "organization_general_info",
        ["primary_email"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_personal_info_normalized_full_name"),
        "personal_info",
