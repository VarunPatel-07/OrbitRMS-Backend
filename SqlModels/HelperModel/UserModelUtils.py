...
class ReportingTo(BaseModel):
    ...
    employee_code = Column(CHAR(30), nullable=True, default=None)
    employee_info = relationship("EmployeeInfo", back_populates="reporting_to")
...
class EmergencyContact(BaseModel):
    ...
    user_id = Column(CHAR(36) , ForeignKey('users.id' , ondelete="CASCADE" , onupdate='CASCADE') , nullable=False)
...
class EmployeeInfo(BaseModel):
    ...
    reporting_to_id = Column(CHAR(36), ForeignKey('reporting_to.id',ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
    reporting_to = relationship("ReportingTo", back_populates="employee_info")
...
class FamilyInfo(BaseModel):
     ...
     children = relationship("Children", back_populates="family_info")
     user_id = Column(CHAR(36) , ForeignKey('users.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False)
